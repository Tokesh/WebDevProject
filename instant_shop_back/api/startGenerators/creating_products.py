def create_product(request):
    ...
    for i in products:
        name = i['title']
        category = Category.objects.get(name=i['type'].capitalize())
        ...
        price = i['price']
        rating = i['rating']
        Product.objects.create(name=name, category=category, description=description, filename=filename, height=height,
                               width=width, price=price, rating=rating)
